...
page = "Home"  # Assign value to page
...
try:
    with open("style.css", "r") as f:  # Ensure file exists
...
try:
    with open(resume_path, "rb") as file:
        st.download_button(label="📥 Download Resume", data=file, file_name="Deepak Mathew resume latest.pdf", mime="application/pdf")
except FileNotFoundError:
    st.warning("⚠️ Resume file not found. Please ensure 'Deepak Mathew Resume.pdf' exists in the project directory.")
